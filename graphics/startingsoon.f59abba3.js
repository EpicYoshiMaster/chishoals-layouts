...
function StartingSoon() {
    ...
    return /*#__PURE__*/ (0, _reactDefault.default).createElement(StyledStartingSoon, {
        __source: {
        ...
        __self: this
    }, "Starting Soon!")))), /*#__PURE__*/ (0, _reactDefault.default).createElement(SocialsRow, {
        __source: {
            fileName: "src/graphics/StartingSoon.tsx",
            lineNumber: 43,
            columnNumber: 6
...
const StyledStartingSoon = (0, _styledComponentsDefault.default).div`
	position: relative;
	width: 1920px;
	height: 1080px;
`;
...
},{"react":"bH1AQ","styled-components":"9xpRL","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}]},["2iwoh"], "2iwoh", "parcelRequired251")
